        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div>
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            <h1>WELCOME</h1>
	            <h4>Fast and Easy Way To Rent A Car to make your travels comfortable and memorable.
	            Start exploring our fleet </h4>
	            <h1 >get ready for your next adventure with us!</h1>
