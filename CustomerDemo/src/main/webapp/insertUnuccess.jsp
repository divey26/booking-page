        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div>
            <div class="signup-image">
              <div class="middle"><br>
                <h1 style="color: black;"> UnSuccessful...! </h1>
  					<div class="tick-image"><br>
                    <div>
                      <img src="images/wrong.png" style="background-size: cover;" width="100" height="100" alt="sing up image">
                    </div>
