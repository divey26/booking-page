	    ...
	    <div class="container">
	      ...
	      <div >
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item "><a href="getbook.jsp" class="nav-link">Home</a></li>
 ...
 <section >
    	<div class="container">
    		<div class="row no-gutters">
                ...
                <form action="log" method="post" class="request-form ftco-animate bg-primary">
...
<!--footer-->
  ...
  <script src="js/date organizer.js"></script>
