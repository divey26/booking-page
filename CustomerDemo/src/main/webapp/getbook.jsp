 ...
 <section >
    	<div class="container">
    		<div class="row no-gutters">
                ...
                <form action="get" method="post" class="request-form ftco-animate bg-primary">
		          		<h2>Your booking</h2>
			    				<div class="form-group">
			    					<label for="" class="label">Enter the Booking ID</label>
			    					<input type="text" class="form-control" name="boid" placeholder="Enter the booking ID">
			    				</div>
			    				
			            <div class="form-group">
			              <input type="submit" name="submit"  value="Get" class="btn btn-secondary py-3 px-4">
			            </div>
